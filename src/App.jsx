    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-8 text-center">
        ...
        <motion.div variants={fadeUp} custom={0} initial="hidden" animate="visible"
          ...
          <span className="text-xs font-semibold text-green-400 tracking-widest uppercase">iOS · Now on App Store</span>
        </motion.div>
        ...
        <motion.div variants={fadeUp} custom={3} initial="hidden" animate="visible"
          ...
          <motion.a
            href="https://apps.apple.com/us/app/apex-coach-ai-gym-tracker/id6761065591"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <span className="text-xs text-white/30">Free · iOS 16+</span>
        </motion.div>
